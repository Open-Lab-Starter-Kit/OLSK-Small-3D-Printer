...
export default function App() {
    ...
    const modelIn = useGLTF('./OLSK_Small_3DPrinter_V3_All_In.glb') //Substitute the file name here for ALL IN
    const modelOut = useGLTF('./OLSK_Small_3DPrinter_V3_All_Out.glb') //Substitute the file name here for ALL OUT
    ...
    useGLTF.clear('./OLSK_Small_3DPrinter_V3_All_In.glb')  //Substitute the file name here for ALL IN
    useGLTF.clear('./OLSK_Small_3DPrinter_V3_All_Out.glb') //Substitute the file name here for ALL OUT
...
useGLTF.preload('./OLSK_Small_3DPrinter_V3_All_In.glb') //Substitute the file name here for ALL IN
useGLTF.preload('./OLSK_Small_3DPrinter_V3_All_Out.glb') //Substitute the file name here for ALL OUT
